...
Citizen.CreateThread(function()
    while true do
		...
		if peacetimeActive then
            ...
            DrawTextAOP(AOPxNew, AOPyNew2, 1.0,1.0,0.45, featColor .. "AOP: ~w~" .. FaxCurAOP .. featColor .. " | ~w~Peace Time: ~r~Wait 25 Minutes", 255, 255, 255, 255)
        elseif not peacetimeActive then
            if peacetime then
                DrawTextAOP(AOPxNew, AOPyNew, 1.0,1.0,0.45, drawTimeText, 255, 255, 255, 255)
                DrawTextAOP(AOPxNew, AOPyNew2, 1.0,1.0,0.45, featColor .. "AOP: ~w~" .. FaxCurAOP .. featColor .. " | ~w~Peace Time: ~g~No Cooldown", 255, 255, 255, 255)
            else
                DrawTextAOP(AOPxNew, AOPyNew, 1.0,1.0,0.45, drawTimeText, 255, 255, 255, 255)
                DrawTextAOP(AOPxNew, AOPyNew2, 1.0,1.0,0.45, featColor .. "AOP: ~w~" .. FaxCurAOP, 255, 255, 255, 255)
            end
		end
    end
end)
